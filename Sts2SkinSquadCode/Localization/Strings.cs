...
internal static class Strings
{
        ...
        new(StringComparer.OrdinalIgnoreCase)
    {
        ["ENG"] = new()
        {
            ...
            ["cfg_swap_label"] = "Swap front position",
            ["cfg_swap_desc"] = "Stand the first squad member in the front (main) spot and move your controlled character one place behind it. Purely visual — you still control the same character.",
            ["btn_squad"] = "Squad",
        ...
        ["KOR"] = new()
        {
            ...
            ["cfg_swap_label"] = "앞자리 교체",
            ["cfg_swap_desc"] = "첫 번째 Squad 동료를 맨 앞(메인) 자리에 세우고, 조작하는 캐릭터를 그 뒤로 옮깁니다. 외형만 바뀔 뿐 조작 대상은 그대로입니다.",
            ["btn_squad"] = "Squad",
        ...
        ["JPN"] = new()
        {
            ...
            ["cfg_swap_label"] = "先頭の位置を入れ替え",
            ["cfg_swap_desc"] = "最初の Squad の仲間を先頭(メイン)の位置に立たせ、操作キャラクターをその後ろに移します。見た目だけで、操作するキャラクターは変わりません。",
            ["btn_squad"] = "Squad",
        ...
        ["ZHS"] = new()
        {
            ...
            ["cfg_swap_label"] = "交换前排位置",
            ["cfg_swap_desc"] = "让第一个 Squad 成员站到最前（主）位置，并把你操作的角色移到其后方。纯外观效果——你操作的仍是同一个角色。",
            ["btn_squad"] = "Squad",
        ...
        ["ZHT"] = new()
        {
            ...
            ["cfg_swap_label"] = "交換前排位置",
            ["cfg_swap_desc"] = "讓第一個 Squad 成員站到最前（主）位置，並將你操作的角色移到其後方。純外觀效果——你操作的仍是同一個角色。",
            ["btn_squad"] = "Squad",
        ...
        ["DEU"] = new()
        {
            ...
            ["cfg_swap_label"] = "Vordere Position tauschen",
            ["cfg_swap_desc"] = "Stellt das erste Squad-Mitglied auf den vorderen (Haupt-)Platz und rückt deinen gesteuerten Charakter einen Platz dahinter. Rein optisch – du steuerst weiterhin denselben Charakter.",
            ["btn_squad"] = "Squad",
        ...
        ["FRA"] = new()
        {
            ...
            ["cfg_swap_label"] = "Échanger la position avant",
            ["cfg_swap_desc"] = "Place le premier membre du Squad au premier plan (position principale) et déplace votre personnage juste derrière. Purement visuel – vous contrôlez toujours le même personnage.",
            ["btn_squad"] = "Squad",
        ...
        ["SPA"] = new()
        {
            ...
            ["cfg_swap_label"] = "Intercambiar la posición delantera",
            ["cfg_swap_desc"] = "Coloca al primer miembro del Squad en el puesto delantero (principal) y mueve a tu personaje controlado justo detrás. Puramente estético: sigues controlando al mismo personaje.",
            ["btn_squad"] = "Squad",
        ...
        ["ITA"] = new()
        {
            ...
            ["cfg_swap_label"] = "Scambia la posizione anteriore",
            ["cfg_swap_desc"] = "Mette il primo membro dello Squad nella posizione anteriore (principale) e sposta il tuo personaggio un posto più indietro. Puramente estetico: controlli sempre lo stesso personaggio.",
            ["btn_squad"] = "Squad",
        ...
        ["PTB"] = new()
        {
            ...
            ["cfg_swap_label"] = "Trocar a posição da frente",
            ["cfg_swap_desc"] = "Coloca o primeiro membro do Squad na posição da frente (principal) e move o seu personagem controlado uma posição atrás. Puramente cosmético — você ainda controla o mesmo personagem.",
            ["btn_squad"] = "Squad",
        ...
        ["POR"] = new()
        {
            ...
            ["cfg_swap_label"] = "Trocar a posição da frente",
            ["cfg_swap_desc"] = "Coloca o primeiro membro do Squad na posição da frente (principal) e move a sua personagem controlada uma posição atrás. Puramente cosmético — continua a controlar a mesma personagem.",
            ["btn_squad"] = "Squad",
            ["tip_drag"] = "Skin Squad – clique para configurar, arraste para mover.",
            ["tip_click"] = "Skin Squad – clique para configurar.",
            ["modal_title"] = "Skin Squad",
        ...
        ["POL"] = new()
        {
            ...
            ["cfg_swap_label"] = "Zamień przednią pozycję",
            ["cfg_swap_desc"] = "Ustawia pierwszego członka Squad na przedniej (głównej) pozycji, a twoją sterowaną postać przesuwa o jedno miejsce za niego. Czysto wizualne — nadal sterujesz tą samą postacią.",
            ["btn_squad"] = "Squad",
        ...
        ["RUS"] = new()
        {
            ...
            ["cfg_swap_label"] = "Поменять переднюю позицию",
            ["cfg_swap_desc"] = "Ставит первого участника Squad на переднее (главное) место, а вашего управляемого персонажа — на одну позицию позади. Исключительно визуально: вы по-прежнему управляете тем же персонажем.",
            ["btn_squad"] = "Squad",
        ...
        ["THA"] = new()
        {
            ...
            ["cfg_swap_label"] = "สลับตำแหน่งด้านหน้า",
            ["cfg_swap_desc"] = "ให้สมาชิก Squad คนแรกยืนในตำแหน่งด้านหน้า (หลัก) และย้ายตัวละครที่คุณควบคุมไปด้านหลังหนึ่งตำแหน่ง เป็นเพียงภาพเท่านั้น — คุณยังควบคุมตัวละครเดิม",
            ["btn_squad"] = "Squad",
        ...
        ["TUR"] = new()
        {
            ...
            ["cfg_swap_label"] = "Ön konumu değiştir",
            ["cfg_swap_desc"] = "İlk Squad üyesini ön (ana) konuma yerleştirir ve kontrol ettiğin karakteri bir sıra arkasına alır. Tamamen görsel — hâlâ aynı karakteri kontrol edersin.",
            ["btn_squad"] = "Squad",
